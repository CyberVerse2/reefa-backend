...
export const httpGetCampaignById = catchAsync(
...
export const httpCreateCampaign = catchAsync(
  async (req: Request, res: Response) => {
    const { user } = req;
...
export const httpUpdateCampaign = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req.params;
    const {
      name,
...
export const httpDeleteCampaign = catchAsync(
  async (req: Request, res: Response) => {
    const { id } = req.params;
    if (!id) {
